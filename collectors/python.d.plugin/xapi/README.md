...
Module monitors one or more XAPI (XenServer, XCP, XCP-ng, etc.).

**Requirements:**
 * python library [XenAPI](https://pypi.org/project/XenAPI/),
   or a more recent version than the one packaged, which can be found at
   https://github.com/xapi-project/xen-api/ under `scripts/examples/python`
